          ...
          <div className="space-y-3">
            {writeups.map((w) => (
              <div
                ...
                className="bg-card border border-border rounded-lg px-4 md:px-5 py-4 flex items-center justify-between cursor-pointer hover:border-primary/50 transition-colors group"
              >
                <div className="flex items-center gap-3 md:gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      <p className="font-medium text-foreground text-sm truncate">{w.title}</p>
